...
X <- fread('/home/eik-tb/OneDrive_andreaivan.costantino@kuleuven.be/GitHub/foveal-feedback-2025/results/20250105-230708_perform_PPI/ppi_results.csv') # Ensure the file path is correct.
...
ggsave("/home/eik-tb/OneDrive_andreaivan.costantino@kuleuven.be/GitHub/foveal-feedback-2025/results/20250105-230708_perform_PPI/ppi_plot.png", g, width = 6, height = 3.5) # Adjust dimensions as needed.
